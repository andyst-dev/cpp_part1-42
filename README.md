...
`cpp_part1` brings together the first part of the 42 C++ curriculum, focused on the foundations of C++98 and object-oriented programming.

It was a good way to build solid foundations in class design, memory handling, inheritance and polymorphism through small progressive exercises.
...
## Learning outcomes
This repository was my first real base in the object-oriented side of C++98.
